...
export default function FavoriteItem({ fav, onClick }) {
  ...
  return (
    <button
      onClick={onClick}
      className="group w-full flex items-center justify-between hover:bg-gray-100 px-2 py-1 rounded-md transition"
    >
      ...
      <span className="text-sm text-right w-[48px]">{fav.symbol}</span>
